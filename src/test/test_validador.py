...
from src.app.utils.validador_entrada import ValidadorEntrada
...
def test_entrada_none_sem_campos_para_ignorar_retorno_excecao():
    ...
    assert str(error.value) == "'NoneType' object has " \
                               "no attribute 'items'"
...
def test_entrada_preenchida_com_campos_para_ignorar_retorno_sucesso():
    ...
    resultado = validador.validar_entradas(
        ["nome", "teste"], payload_valores_dict)
